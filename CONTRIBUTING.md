...
- Existing skills in [.github/skills/](.github/skills/)
...
1. **Create a directory** for your skill in `.github/skills/`:
   ```bash
...
4. **Update the skills README** at `.github/skills/README.md` to include your new skill
...
# Validate your skill
skills validate .github/skills/your-skill-name/SKILL.md
```
