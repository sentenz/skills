...
- [5. Example Projects](#5-example-projects)
  - [5.1. C++ Project with GoogleTest](#51-c-project-with-googletest)
  - [5.2. Go Project](#52-go-project)
  - [5.3. Multi-Language Project](#53-multi-language-project)
- [6. Tips for Effective Usage](#6-tips-for-effective-usage)
...
```bash
# Copy all skills
cp -r path/to/skills/skills .github/

# Or copy specific skills only
mkdir -p skills
cp -r path/to/skills/skills/cpp-unit-testing skills/
cp -r path/to/skills/skills/cpp-api-documentation skills/
```
...
mkdir -p skills
ln -s ../skills-catalog/skills/cpp-unit-testing skills/cpp-unit-testing
...
- See [Go Unit Testing](skills/go-unit-testing/SKILL.md)
