...
- [TM7 Threat Model](tm7-threat-model/SKILL.md)
  > External Agent Skill from GitHub's [awesome-copilot catalog](https://github.com/github/awesome-copilot/tree/main/skills%2Ftm7-threat-model) for generating valid Microsoft Threat Modeling Tool v7.3+ files with diagrams and STRIDE threats.
